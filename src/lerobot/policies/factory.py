...
def get_policy_class(name: str) -> PreTrainedPolicy:
    ...
    if name == "tdmpc":
        ...
        from lerobot.policies.smolvla_3d.modeling_smolvla3d import SmolVLAPolicy3d

        return SmolVLAPolicy3d
    elif name == "smolvla_hq":
        from lerobot.policies.smolvla_hq.modeling_smolvla_hq import SmolVLAPolicyHQ

        return SmolVLAPolicyHQ
    elif name == "smolvla3d_cavla":
        from lerobot.policies.smolvla_3dcavla.modeling_smolvla3d_cavla import SmolVLAPolicy3d_cavla
