...
class SmolVLAPCPPolicy(PreTrainedPolicy):
    """Wrapper class around VLAFlowMatching model to train and run inference within LeRobot."""

    config_class = SmolVLAPCPConfig
    name = "smolvla"

    def __init__(
        self,
        config: SmolVLAPCPConfig,
...
class VLAFlowMatching(nn.Module):
    ...
    def __init__(self, config: SmolVLAPCPConfig):
        super().__init__()
        self.config = config

        self.vlm_with_expert = SmolVLMPCPWithExpertModel(
